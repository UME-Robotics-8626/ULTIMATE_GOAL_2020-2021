 ...
 */
public abstract class IMUAMecBase extends LinearOpMode {

    protected DcMotor	 leftFrontMotor; // The front left motor
    protected DcMotor	 leftBackMotor; // The front right motor
    protected DcMotor	 rightFrontMotor; // The right rear motor
    protected DcMotor	 rightBackMotor; // The left rear motor
    ...
    protected void preStartInitialization() {
        ...
        leftBackMotor = hardwareMap.dcMotor.get("FrontRight");
        rightFrontMotor = hardwareMap.dcMotor.get("BackLeft");
     ...
     *
     * @param rightFrontPower (double) The right front wheel power in the range -1.0 to 1.0.
     * @param rightBackPower (double) The right rear wheel power in the range -1.0 to 1.0.
     * @param leftFrontPower (double) The left front wheel power in the range -1.0 to 1.0.
     * @param leftBackPower (double) The left rear wheel power in the range -1.0 to 1.0.
     */
